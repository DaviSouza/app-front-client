...
# Compatível com CodeBuild/Terraform que ainda passam VITE_COGNITO_*
ARG VITE_COGNITO_AUTHORITY
ARG VITE_COGNITO_CLIENT_ID
ARG VITE_REALTIME_SSE_URL
ARG VITE_REALTIME_HTTP_URL

# Preferir COGNITO_*; se vazio, usar VITE_COGNITO_* do CI
ENV VITE_API_GATEWAY_URL=$VITE_API_GATEWAY_URL \
    COGNITO_AUTHORITY=${COGNITO_AUTHORITY:-$VITE_COGNITO_AUTHORITY} \
